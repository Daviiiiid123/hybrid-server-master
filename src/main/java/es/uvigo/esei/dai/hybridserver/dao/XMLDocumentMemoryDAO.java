...
/**
 * Implementación en memoria del DAO para documentos XML.
 * Utiliza un ConcurrentHashMap para garantizar thread-safety.
 */
public class XMLDocumentMemoryDAO implements XMLDocumentDAO {
    
    private final Map<String, String> documents;
    
    public XMLDocumentMemoryDAO() {
        this.documents = new ConcurrentHashMap<>();
    }
    
    public XMLDocumentMemoryDAO(Map<String, String> initialDocuments) {
        this.documents = new ConcurrentHashMap<>();
