...
/**
 * Interface para el acceso a datos de documentos XSD.
 * Permite implementaciones tanto en memoria como en base de datos.
 */
public interface XSDDocumentDAO {
    
    /**
     * Obtiene todos los documentos XSD almacenados.
     * @return Mapa con UUID como clave y contenido XSD como valor
     */
    Map<String, String> getAllDocuments() throws SQLException;
    
    /**
     * Obtiene un documento XSD por su UUID.
     * @param uuid Identificador único del documento
     * @return Contenido XSD del documento, o null si no existe
     */
    String getDocument(String uuid) throws SQLException;
    
    /**
     * Almacena un nuevo documento XSD.
     * @param uuid Identificador único del documento
     * @param content Contenido XSD del documento
